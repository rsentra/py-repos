...
def hide_sidebar():
    ...
    hide_pages(['Main', 'Chart','Intro','KMS_embed','QA_chat', 'pdf_parser'])  #main과 pages 디렉토리에 있는 메뉴를 숨김

hide_sidebar() 

with st.sidebar:
    selected = option_menu("Main Menu", [ 'KMS Embedding','Chat',"Prompt",'Parser','Setting'], 
